...
void setup()
{
  ...
  SerialUSB.begin(9600); //Start serial communication at 9600 for debug statements
  SerialUSB.println("OpenLCD Example Code");
...
void loop()
{
  ...
  delay(500); //The maximum update rate of OpenLCD is about 100Hz (10ms). A smaller delay will cause flicker
}
